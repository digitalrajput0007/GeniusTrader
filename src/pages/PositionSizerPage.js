...
const PositionSizerPage = () => {
    ...
    return (
        <div className="position-sizer-page-box">
            ...
            <div className="bg-surface p-8 rounded-lg shadow-lg max-w-lg mx-auto border border-gray-700 position-sizer-page-box">
                <div className="space-y-6">
                    <div>
                        <label htmlFor="capital" className="block text-sm font-medium text-text-secondary mb-1">Account Capital (₹)</label>
                        <input type="number" name="capital" id="capital" value={formData.capital} onChange={handleChange} className="w-full p-3 bg-surface-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary transition" placeholder="e.g., 100000" />
                    </div>
                    <div>
                        <label htmlFor="riskPercent" className="block text-sm font-medium text-text-secondary mb-1">Risk per Trade (%)</label>
                        <input type="number" name="riskPercent" id="riskPercent" value={formData.riskPercent} onChange={handleChange} className="w-full p-3 bg-surface-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary transition" placeholder="e.g., 1" />
                    </div>
                    <div>
                        <label htmlFor="entry" className="block text-sm font-medium text-text-secondary mb-1">Entry Price (₹)</label>
                        <input type="number" name="entry" id="entry" value={formData.entry} onChange={handleChange} className="w-full p-3 bg-surface-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary transition" placeholder="e.g., 100" />
                    </div>
                    <div>
                        <label htmlFor="stopLoss" className="block text-sm font-medium text-text-secondary mb-1">Stop-Loss Price (₹)</label>
                        <input type="number" name="stopLoss" id="stopLoss" value={formData.stopLoss} onChange={handleChange} className="w-full p-3 bg-surface-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary transition" placeholder="e.g., 98" />
                    </div>
                ...
                {result && (
                    <div className="mt-6 p-6 bg-surface-secondary rounded-lg text-center border border-gray-700">
