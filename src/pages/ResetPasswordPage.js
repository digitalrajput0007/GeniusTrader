...
const ResetPasswordPage = () => {
  ...
  if (loading && !isValidCode) {
    return (
      <div className="flex min-h-screen items-center justify-center px-4 text-slate-100 relative">
        <AnimatedAuthBackground />
        <div className="relative z-10 rounded-lg border border-white/10 bg-slate-950/70 px-6 py-5 text-sm text-slate-300 shadow-lg">
